...
#             except KeyError:
#                 continue
#         users = UserPro.objects.filter(username=auser.nickname)
#         if users:
#             user = users.first()
#             img = user.avatar
#         else:
...
#         email = UserPro.objects.get(id=uid).email
#         user = UserPro.objects.get(username=username, id=uid)
#         if fun == "me-comment":
...
#         if fun == "me-article":
#             author = UserPro.objects.get(username=username, id=uid)
